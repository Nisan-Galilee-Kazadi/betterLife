            ...
            <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24">
                ...
                <div className="mb-20">
                    <div className="text-center mb-12">
                        <SectionTitle kicker={t('projets.index.map.kicker')} title={t('projets.index.map.title')} />
                ...
                <div>
                    <div className="text-center mb-12">
                        <SectionTitle kicker={t('projets.index.featured.kicker')} title={t('projets.index.featured.title')} />
                    </div>
                    <div className="grid gap-8 lg:grid-cols-3">
                        {projects.map((project) => (
                            <div key={project.id} className="rounded-2xl border-2 border-slate-200 bg-white p-6 shadow-lg transition hover:shadow-xl hover:border-[#63b32e]">
                                <div className="mb-4">
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex items-center justify-between text-sm">
                                        ...
                                        <span className="font-semibold text-slate-900">{project.beneficiaries}</span>
                                    </div>
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="text-slate-600 flex items-center gap-2">
                                    ...
                                    {project.trees !== '0' && (
                                        <div className="flex items-center justify-between text-sm">
                                            ...
                                            <span className="font-semibold text-slate-900">{project.trees}</span>
                                        </div>
                                    )}
                                </div>
