...
import { FaTree, FaSeedling, FaLeaf, FaChartLine, FaUsers, FaHandsHelping } from 'react-icons/fa'
                        ...
                        {t('services.reboisement.nurseries.items').map((nursery, index) => {
                            ...
                            return (
                                <div key={index} className="rounded-2xl bg-white p-8 shadow-lg ring-1 ring-slate-900/5 transition hover:shadow-xl hover:ring-[#63b32e]/20">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900 mb-2">{nursery.name}</h3>
                                    <div className="space-y-2 mb-6">
                                        <p className="text-sm text-slate-600">
                                            <span className="font-semibold text-[#0f70b7]">{t('common.capacity')}:</span> {nursery.capacity}
                                        </p>
                                        <p className="text-sm text-slate-600">
                                            <span className="font-semibold text-[#0f70b7]">{t('common.species')}:</span> {nursery.species}
                                        </p>
                                    </div>
                    ...
                    <div className="grid gap-12 lg:grid-cols-2">
                        <div className="rounded-2xl bg-green-50 border-2 border-green-200 p-8">
                            ...
                            <ul className="space-y-4">
                                {t('services.reboisement.benefits.env.items').map((benefit, index) => (
                        ...
                        <div className="rounded-2xl bg-blue-50 border-2 border-blue-200 p-8">
                            ...
                            <ul className="space-y-4">
                                {t('services.reboisement.benefits.socio.items').map((benefit, index) => (
                                    <li key={index} className="flex items-start gap-3">
