        ...
        <div className="bg-white" style={{ fontFamily: 'Times New Roman, serif' }}>
            ...
            <div className="border-b-4 border-black py-6">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <h2 className="text-3xl text-gray-700 text-center mt-2">Santé Naturelle</h2>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <article className="border-b-4 border-black pb-6">
                            <h3 className="text-3xl font-bold mb-4 text-gray-900">
                                La Révolution des Plantes Médicinales au Congo
                            </h3>
                            ...
                            <div className="prose prose-lg max-w-none text-gray-800 leading-relaxed">
                                <p className="text-lg mb-4 first-letter:text-6xl first-letter:font-bold first-letter:float-left first-letter:mr-2 first-letter:mt-1">
                                    Notre programme de plantes médicinales combine santé naturelle et développement économique pour les communautés rurales.
                                </p>
                                
                                <p className="mb-4">
                                    Le programme Plantes Médicinales de Better Life représente une avancée majeure dans l'agriculture durable congolaise. 
                                    Nos fermes partenaires cultivent désormais des plantes médicinales de qualité supérieure, reconnues sur les marchés internationaux 
                                    pour leurs propriétés thérapeutiques exceptionnelles.
                                </p>

                                <div className="my-6">
                                    <img 
                                        src={imgHero} 
                                        alt="Jardin de plantes médicinales" 
                                        className="w-full h-64 object-cover rounded-lg"
                                    />
                                    <p className="text-sm text-gray-600 mt-2 italic text-center">
                                        Vue de notre jardin de plantes médicinales dans la région du Katanga
                                    </p>
                                </div>
                                ...
                                <p className="mb-4">
                                    ...
                                    tout en augmentant les rendements. L'association de plantes médicinales avec des arbres fruitiers et des essences 
                                    forestières crée un écosystème résilient et productif.
                                </p>

                                <div className="bg-gray-100 p-4 border-l-4 border-black my-6">
                                    <p className="text-lg italic">
                                        "La culture des plantes médicinales a multiplié nos revenus par cinq tout en protégeant nos forêts. 
                        ...
                        <article className="border-b-2 border-gray-300 pb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <img 
                                    src={imgHero} 
                                    alt="Ferme de plantes médicinales" 
                                    className="w-full h-48 object-cover rounded-lg"
                                />
                                <img 
                                    src={imgHero} 
                                    alt="Récolte de plantes médicinales" 
                                    className="w-full h-48 object-cover rounded-lg"
                                />
                            </div>
                            ...
                            <div className="prose text-gray-800 leading-relaxed">
                                <p className="mb-4">
                                    Le programme a déjà transformé la vie de plus de 1,800 familles d'agriculteurs. 
                                    Les revenus moyens ont augmenté de 400%, permettant aux enfants de poursuivre leurs études 
                        ...
                        <article className="pb-6">
                            ...
                            <img 
                                src={imgHero} 
                                alt="Transformation de plantes médicinales" 
                            ...
                            <div className="prose text-gray-800 leading-relaxed">
                                <p className="mb-4">
                                    ...
                                    de la plante aux produits de santé. Cette approche garantit une qualité exceptionnelle 
                                    et maximise les bénéfices pour nos agriculteurs.
                                </p>
                                
                                <p>
                                    Les produits médicinaux Better Life sont désormais disponibles dans les pharmacies spécialisées 
                        ...
                        <div className="bg-black text-white p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="text-center border-b border-white/30 pb-2">
                                    ...
                                    <div className="text-sm">Espèces cultivées</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-yellow-50 border-2 border-yellow-200 p-6">
                            ...
                            <ul className="space-y-2 text-gray-800">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span className="text-sm">Plantes médicinales locales</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-yellow-600 mt-1">▸</span>
                                    <span className="text-sm">Culture biologique</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-yellow-600 mt-1">▸</span>
                                    <span className="text-sm">Transformation locale</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-yellow-600 mt-1">▸</span>
                        ...
                        <div className="bg-gray-100 p-6 text-center">
                            ...
                            <div className="bg-white p-4 border border-gray-300">
                                ...
                                <p className="text-sm text-gray-600 mb-3">
                                    Achetez des produits médicinaux Better Life et soutenez l'agriculture durable
                                </p>
                                <Link
                                    to="/contact"
