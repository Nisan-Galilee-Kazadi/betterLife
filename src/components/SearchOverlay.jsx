...
function keyToRoute(key) {
  const rules = [
    ...
    {
      test: (k) => k.startsWith("services.agriculture"),
      path: "/Services/agriculture",
      section: "Services",
    },
    {
      test: (k) => k.startsWith("services.reboisement"),
      path: "/Services/reboisement",
      section: "Services",
    },
    {
      test: (k) => k.startsWith("services.biodiversite"),
      path: "/Services/biodiversite",
      section: "Services",
    },
    {
      test: (k) => k.startsWith("services.communautaire"),
      path: "/Services/communautaire",
      section: "Services",
    },
    {
      test: (k) => k.startsWith("services.elevage"),
      path: "/Services/elevage",
      section: "Services",
    },
    // Offres removed
    // Projets removed
