export const fr = {
  ...
  nav: {
    ...
    elevage_chiens: "Élevage des chiens",
    elevage_serpents: "Élevage des serpents",
    apiculture: "Apiculture",
    projet_communautaire: "Projet Communautaire",
    sante: "Santé",
    energie: "Énergie",
    education: "Éducation",
    route_desserte_agricole: "Route de desserte agricole",
    habitation: "Habitation",
    mecanisation: "Mécanisation agricole",
    tracteur: "Tracteur",
  ...
  about: {
    mission: {
      ...
      mission: {
        ...
        text: "Nous œuvrons quotidiennement pour la protection de l'environement, la conservation de la biodiversité et la promotion de la sécurité alimentaire.",
      ...
      values: {
        ...
        items: [
          {
            title: "Microcrédit et Entreprenariat",
          ...
          },
          {
            ...
            desc: "Développement des compétences techniques et entrepreneuriales pour les jeunes et les femmes.",
            impact: "2000+ personnes formées"
          },
          {
            title: "Accès à l'Eau Potable",
            desc: "Installation de forages et systèmes d'adduction d'eau dans les communautés rurales.",
            impact: "50+ points d'eau construits"
          },
          {
            title: "Agriculture Durable",
            desc: "Formation aux techniques d'agroécologie et d'agroforesterie pour une production durable.",
            impact: "1000+ agriculteurs formés"
          },
          {
            title: "Sécurité Alimentaire",
            desc: "Programmes de nutrition et de diversification alimentaire pour lutter contre la malnutrition.",
            impact: "5000+ personnes impactées"
          },
          {
            title: "Autonomisation des Femmes",
            desc: "Programmes spécifiques pour renforcer le leadership et l'indépendance économique des femmes.",
            impact: "1000+ femmes accompagnées"
          }
        ],
      },
      impact: {
        ...
        items: [
          {
            title: "Protection de l'environement",
    ...
    team: {
      hero: {
        title: "Notre Équipe",
        subtitle:
          "Des experts passionnés dédiés à la protection de l'environement et au développement durable",
      },
      leadership: {
        kicker: "Leadership",
        title: "L'Équipe de Direction",
        text: "Une équipe multidisciplinaire combinant expertise scientifique, expérience terrain et passion pour l'environement",
      },
      members: [
        {
    ...
    partners: {
      hero: {
        ...
        subtitle:
          "Ensemble, nous créons un impact durable pour l'environement et les communautés",
      },
      intro: {
      ...
      strategic: {
        ...
        items: [
          {
            name: "Programme des Nations Unies pour l'environement",
            acronym: "PNUE",
      ...
      local: {
        ...
        items: [
          {
            name: "Ministère de l'environement et de la Nature",
            acronym: "MEN",
            type: "Ministère",
            desc: "Collaboration sur les programmes de conservation de la biodiversité et lutte contre le changement climatique.",
            focus: ["Climat", "Biodiversité", "Financement"],
  ...
  contact: {
    hero: {
      ...
      subtitle: "N'hésitez pas à nous contacter pour toute question ou partenariat",
    },
    info: {
  ...
  home: {
    hero: {
      ...
      subtitle:
        "Notre mission est de protéger l'environnement, la biodiversité, lutter pour la conservation de la nature, le bien-être de la population et promouvoir la sécurité alimentaire.",
    ...
    testimonials: {
      ...
      t1: {
        quote:
          "Grâce à Better Life, mes revenus ont triplé et ma terre est plus fertile qu'avant. La formation en agriculture durable a vraiment changé ma vie.",
        author: "Marie Nkulu",
    ...
    cta: {
      title: "Rejoignez Notre Mission",
      subtitle:
        "Ensemble, nous pouvons créer un avenir durable pour la RDC et protéger notre environement",
      btn1: "Faire un don",
  ...
  footer: {
    description:
      "Protection de l'environement, Biodiversité et Développement Durable en République Démocratique du Congo.",
  ...
  blog: {
    index: {
      ...
      items: {
        excerpt:
          "Ajoutez ici l'extrait, les médias (photo/vidéo) et le lien vers l'article complet.",
        readMore: "Lire l'article",
      },
      sections: {
        interviews: {
          title: "Interviews et vidéos",
          desc: "Retrouvez ici les ressources multimédias : témoignages de producteurs, partenaires, coulisses du terrain.",
        },
        campaigns: {
          title: "Campagnes en cours",
          desc: "Annonces d'événements, levées de fonds, journées de reboisement, sessions de formation ouvertes.",
        },
      },
    },
    news: {
  ...
  Actions: {
    ...
    environement: {
      ...
      intro: {
        kicker: "Protection",
        title: "Actions pour l'environement",
      ...
      impact: {
        title: "Notre Impact environemental",
        stats: [
      ...
      eco_kelasi: {
        ...
        intro: { title: "Éducation environementale", text: "Apprendre à aimer et protéger la nature dès le plus jeune âge." },
    ...
    elevage: {
      ...
      Actions: {
        kicker: "Services",
        title: "Appui aux Éleveurs",
        items: [
          { title: "Santé Animale", features: ["Vaccination", "Soins vétérinaires", "Prévention maladies"] },
          { title: "Amélioration Génétique", features: ["Croisement", "Sélection", "Races performantes"] },
          { title: "Formation", features: ["Gestion d'élevage", "Hygiène", "Alimentation"] },
          { title: "Infrastructures", features: ["Construction abris", "Mangeoires", "Abreuvoirs"] }
        ]
      },
      story: {
        tag: "Témoignage",
        title: "Réussite Locale",
        text: "L'installation d'unités avicoles modernes a permis à 50 femmes de la coopérative de doubler leurs revenus en un an.",
        benefits: ["Autonomie financière", "Sécurité nutritionnelle", "Renforcement des capacités"],
        stats: [
          { label: "Volailles", value: "5000+", color: "green" },
          { label: "Revenus", value: "+100%", color: "blue" }
        ]
      },
      stats: {
        title: "Chiffres Clés",
        items: [
          { number: "250", label: "Éleveurs soutenus" },
          { number: "10k", label: "Têtes de bétail" },
          { number: "5T", label: "Miel produit" },
          { number: "12", label: "Unités piscicoles" }
        ]
      },
      cta: {
    ...
    communautaire: {
      ...
      intro: {
        ...
        stats: [
          { value: "50+", label: "Communautés soutenues" },
          { value: "10k+", label: "Bénéficiaires directs" },
          { value: "200+", label: "Projets réalisés" },
          { value: "5", label: "Provinces couvertes" }
        ]
      },
      programs: {
        kicker: "Nos Programmes",
      ...
      women: {
        ...
        stats: [
          { number: "2,000+", label: "Femmes formées" },
          { number: "300+", label: "Micro-entreprises créées" },
          { number: "85%", label: "Taux de réussite" },
          { number: "10", label: "Coopératives soutenues" }
        ],
        testimonial: {
          text: "Grâce à la formation en entrepreneuriat, j'ai pu créer ma petite entreprise et subvenir aux besoins de ma famille.",
          author: "Marie K., Bénéficiaire du programme"
        }
      },
      stories: {
